...
function initShadersRGB(entity) {
	...
	result = result.replace("VALUESCALE", globalScale.toFixed(3).toString());
	result = result.replace("VALUEXREF", globalXRef.toFixed(3).toString());
	result = result.replace("VALUEYREF", globalYRef.toFixed(3).toString());
